    ...
    init(reference) {
        ...
        self[self.cases.names.caseName1] = function () {
            ...
            try {
                ...
                jsql.insert("84267e161101952559c1458963a031c0e25030492b60")
                    .params({
                        name: 'Mirek',
                        surname: 'Wołyński',
                        age: 38
        ...
        self[self.cases.names.caseName2] = function () {
            ...
            try {
                ...
                jsql.insert("84267e1611513525e911d5397390f16022b3a110c5030492b60")
        ...
        self[self.cases.names.caseName3] = function () {
            ...
            try {
                ...
                jsql.update("84267e1611119595092145f9d3f0c15062e675bf8fe827dde4986ad791cb5030492b60")
                    .param('age', 30)
                    .then(function (result) {
        ...
        self[self.cases.names.caseName4] = function () {
            ...
            try {
                ...
                jsql.update("84267e161161f56539012519f3e00140925030492b60")
                    .params(['osobowy'])
                    .then(function (result) {
        ...
        self[self.cases.names.caseName5] = function () {
            ...
            try {
                ...
                jsql.selectOne("84267e161181855539c1d5f9d33071a07390424341fc1ccd3a3721b1314d5030492b60")
                    .param('ageMin', 30)
                    .param('ageMax', 50)
                    .then(function (result) {
        ...
        self[self.cases.names.caseName6] = function () {
            ...
            try {
                ...
                jsql.select("84267e161161c5d569212599c30071403362582d3b226f0c6d825030492b60")
                    .then(function (result) {
        ...
        self[self.cases.names.caseName7] = function () {
            ...
            try {
                ...
                jsql.remove("84267e1611c1555539c1e59903a0e170d3544fc62490e7427c8175f5030492b60")
                    .then(function (result) {
        ...
        self[self.cases.names.caseName8] = function () {
            ...
            try {
                ...
                jsql.remove("84267e1611d14545490155d913806170f5c8555bce49e5c456c5030492b60")
                    .params({
                        price: 10.000
                    })
                    .then(function (result) {
        ...
        self[self.cases.names.caseName9] = function () {
            ...
            try {
                ...
                transaction.insert("84267e1611513525e911d5397390f16022b3a110c5030492b60")
